    ...
    <div class="main">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <tr>
                ...
                <td>Product image: </td>
                <td>
                    <img src="../img/product/<?php echo $current_image; ?>" style="margin-left: 10px;" width="70px" height="70px" name="current_img">
                </td>
            ...
            if (isset($_POST['submit'])) {
                ...
                if (isset($_FILES['prd_image']['name'])) {
                    ...
                    if ($prd_image != "") {
                        ...
                        $prd_image = "food_".rand(000, 999).'.'.$ext;
                        $source_path = $_FILES['prd_image']['tmp_name'];
                        $destination = "../img/product/".$prd_image;
                        ...
                        $remove = unlink('../img/product/'.$current_image);
                        if ($remove==FALSE) {
