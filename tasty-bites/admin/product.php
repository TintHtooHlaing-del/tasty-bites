...
<body>
    ...
    <div class="main-admin" style="width:80%; margin: 100px auto 20px;">
        <h2 style="margin: 30px;">Products</h2><a href="dis-product.php">Discount Product?</a>
        <?php 
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($prd_name!="") {
                                        ?>
                                        <img src="../img/product/<?php echo $prd_image; ?>" width="70px" height="70px">
                                        <?php
                                    }else{
                                        echo "No image added.";
                                    }
                                ...
                                <td style="line-height: 70px"><a href="update-product.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a></td>
                                <td style="line-height: 70px"><a href="delete-product.php?id=<?php echo $id; ?>&prd_image=<?php echo $prd_image; ?>" class="btn btn-danger">Delete</a></td>
                            </tr> 
