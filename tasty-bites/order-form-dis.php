<?php 
    ...
    if (isset($_GET['id'])) {
        ...
        if ($count==1) {
            ...
            $or_price = $row['prd_price'];
            $prd_price = $row['dis_price'];
...
<body>
    ...
    <div>
        ...
        <div class="detail">
                ...
                if ($prd_name!="") {
                ?>
                    <img src="img/dis-product/<?php echo $prd_image; ?>" name="prd_image">              
                <?php
                }else{
                    echo "No image added.";
                }
                ?>
            <h4 class="pd-name" style="margin-top: 0px;"><?php echo $prd_name; ?></h4>
            <p class="pd-price">Original Price: <del style="text-decoration: line-through;"><?php echo $or_price; ?></del> Ks</p>
            <p class="pd-price">Discount Price: <?php echo $prd_price; ?> Ks</p>
        </div><br><br>
